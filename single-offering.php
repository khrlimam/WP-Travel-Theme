      ...
      <div class="row">
        <div class="col-xl-12">
          <div class="hero-cap text-center">
            <span
              style="color: red;font-weight: bold;font-size: 14px"><?php echo esc_html(get_post_meta(get_the_ID(), 'discount_value', true)); ?>
              OFF!</span>
            <h2><?php the_title() ?></h2>
            <ul class="list-unstyled mb-4 text-white">
              <li><strong>Price:</strong> <span
                  style="font-size:14px;text-decoration: line-through"><?php echo esc_html(get_post_meta(get_the_ID(), 'prev_price', true)); ?></span>
                <span
                  style="font-weight: bold;font-size: 20px"><?php echo esc_html(get_post_meta(get_the_ID(), 'new_price', true)); ?></span>
              </li>
              <li><strong>Duration:</strong> <?php echo esc_html(get_post_meta(get_the_ID(), 'durations', true)); ?>
              </li>
              <li><strong>Location:</strong> <?php echo esc_html(get_post_meta(get_the_ID(), 'locations', true)); ?>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <a href="https://wa.me/6287802458279?text=Hi,%20Hassava%20Transwisata%0AI%20want%20to%20know%20more%20about%20the%20package%20<?php the_title() ?>.%0A<?= the_permalink() ?>%0AThanks."
              target="_blank" class="genric-btn primary radius btn-block">Get The Offer Now!</a>
    ...
    <div class="favourite-place place-padding">
      <div class="container">
        <div class="row">
          ...
          <div class="row">
            <div class="col-12">
              <h3>You might interested to other deals:</h3>
            </div>
          </div>
        </div>
        <div class="row mt-5">

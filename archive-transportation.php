...
<main>
  <div class="container py-5">
    <h1 class="mb-4">All Transportations</h1>
        ...
        <div class="row">
          ...
          if (have_posts()):
            while (have_posts()):
              ...
              $destination = "$from - $to";
              $capacity = get_post_meta(get_the_ID(), 'car_capacity', true);
                  ...
                  <div class="place-cap">
                    <div class="place-cap-top">
                      ...
                      <p class="dolor">
                        ...
                        <br>
                        <span><?php echo esc_html($capacity); ?> Peoples</span>
                      </p>
                    </div>
                    <div class="place-cap-bottom">
                      <ul>
                        <li><i class="fas fa-map-marker-alt"></i><span class="badge badge-info"><?php echo esc_html(strtoupper($type)); ?></span> <?php echo esc_html($destination); ?></li>
                      </ul>
                    </div>
                  </div>
                </div>
